export default {
	...
	wallet: {
		...
		createWalletTipOfNoStore:
			'Do remember your password! MyCryptos will not store and cannot find back your password！',
	...
	my: {
		home: {
			...
			aboutUs: {
				...
				introduction:
					'MyCryptos is a mobile light wallet APP designed to provide ordinary users with a secure, easy-to-use, powerful digital asset wallet application.',
	...
	public: {
		...
		privateKey_ps:
			'PS: The user can use the plaintext private key to import MyCryptos, generate a new Keystore with a new password (remember to delete the old Keystore), and use this method to modify the wallet password.'
	}
};
