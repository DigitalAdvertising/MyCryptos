export default {
	...
	wallet: {
		...
		createWalletTipOfNoStore: 'MyCryptos不会储存密码，也无法帮您找回，请务必牢记！',
	...
	my: {
		home: {
			...
			aboutUs: {
				_title: '关于我们',
				currentVersion: '当前版本',
				introduction: 'MyCryptos是一款移动端轻钱包APP,它旨在为普通用户提供一款安全放心，简单好用，功能强大的数字资产钱包应用。',
				useAgreement: '用户协议',
				privacyPolicy: '隐私条款',
				versionLog: '版本日志',
				checkVersion: '检测新版'
	...
	public: {
		...
		privateKey_ps: 'PS: 用户可以使用明文私钥导入 MyCryptos，用新的密码生成一个新的 Keystore (记得要将旧的 Keystore 删除)，用这种方法来修改钱包密码。'
	}
};
